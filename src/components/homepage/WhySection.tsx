...
const Card: React.FC<CardProps> = ({ icon, title, description }) => {
  return (
    <div className="bg-black/20 ring-2 ring-red-600 shadow-md rounded-lg p-6 flex flex-col items-center text-center">
...
const WhySkillNetSection: React.FC = () => {
  return (
    <section className="bg-gradient-to-b from-black via-red-900 to-black py-16">
